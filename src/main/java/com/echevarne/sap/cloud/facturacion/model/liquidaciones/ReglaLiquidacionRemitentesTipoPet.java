...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesTipoPet")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesTipoPet extends BasicEntity {
	...
	public ReglaLiquidacionRemitentesTipoPet(String tipoPeticion) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesTipoPet other = (ReglaLiquidacionRemitentesTipoPet) obj;
