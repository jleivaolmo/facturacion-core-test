...
@Entity 
@Table(name = "V_COBROS_CON_ACTIVIDAD_FACTURADA")
@ToString(callSuper = false, includeFieldNames = false)
@Getter
@Setter
@Builder
@SapEntityType(semantics = SemanticsTypeEnum.AGGREGATE)
public class CobroYActFacturada implements Serializable {

	private static final long serialVersionUID = 1810645895260818963L;
	...
	@Column(precision = 16, scale = 2)
	@GroupByField(fieldName = "cantidad")
	...
	@Basic
	@Column(name = "codigo_prueba_btp")
	@GroupByField(fieldName = "codPruebaBTP")
	@Sap(visible = false)
