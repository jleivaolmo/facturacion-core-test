...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesPrueba")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesPrueba extends BasicEntity {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5717666681965643050L;

	@Basic
	@ValueList(CollectionPath = ValueListEntitiesEnum.MaterialesVenta, Label = "Prueba", Parameters = {
	...
	public ReglaLiquidacionRemitentesPrueba(String prueba) {
		this.prueba = prueba;
	}
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesPrueba other = (ReglaLiquidacionRemitentesPrueba) obj;
		return Objects.equals(prueba, other.prueba);
	}
}
