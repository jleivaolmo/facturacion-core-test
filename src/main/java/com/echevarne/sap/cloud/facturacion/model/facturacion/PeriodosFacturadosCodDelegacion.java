...
@Entity
@Table(name = ConstEntities.ENTIDAD_FACTLOGPERIODOSCODDELEGACION)
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
@SapEntitySet(creatable = false, updatable = false, searchable = true, deletable = false)
public class PeriodosFacturadosCodDelegacion extends BasicEntity {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PeriodosFacturadosCodDelegacion other = (PeriodosFacturadosCodDelegacion) obj;
		return Objects.equals(codDelegacion, other.codDelegacion);
	}
