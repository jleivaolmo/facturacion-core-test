...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesCliente")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesCliente extends BasicEntity {
	...
	public ReglaLiquidacionRemitentesCliente(String codigoCliente) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesCliente other = (ReglaLiquidacionRemitentesCliente) obj;
