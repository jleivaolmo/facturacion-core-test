...
@Table(name = "VT_EMPRESAS")
@SapEntitySet(creatable = false, updatable = false, searchable = true)
@JPAExit(allowAll = true, fieldId = "codigoEmpresa", fieldDescription = "nombreEmpresa")
public class EmpresasText implements Serializable {
