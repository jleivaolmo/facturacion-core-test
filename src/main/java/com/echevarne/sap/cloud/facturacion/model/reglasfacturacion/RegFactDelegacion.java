...
@Getter
@Setter
@Table(name = "T_RegFactDelegacion")
@SapEntitySet(creatable = true, updatable = true, searchable = true)
@Cacheable(false)
public class RegFactDelegacion extends ReglaFactBase {

	/**
	 *
	 */
	private static final long serialVersionUID = 1093138783453853508L;
     ...
     *
     ********************************************/
	public RegFactDelegacion(ReglasFacturacion regla) {
		this.regla = regla;
	}
	...
	public void prePersist() {
	    if(StringUtils.equalsAnyOrNull(this.codigoDelegacion,StringUtils.EMPTY))
	    	this.codigoDelegacion = StringUtils.ANY;
	}
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegFactDelegacion other = (RegFactDelegacion) obj;
		return Objects.equals(codigoDelegacion, other.codigoDelegacion);
	}
