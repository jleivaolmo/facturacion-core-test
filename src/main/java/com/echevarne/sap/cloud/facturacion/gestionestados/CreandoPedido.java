...
@Component(CreandoPedido.CODIGO)
public class CreandoPedido extends FacturacionEstado {

	public static final String CODIGO = "CP";
	...
	public boolean doTransicion(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		return validacionesSolInd.hasItemsStatus(solicitudIndividual, CreandoPedido.CODIGO).isValid();
	}
	
	@Override
	public boolean doTransicionV2(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		return validacionesSolInd.hasItemsStatusV2(solicitudIndividual, CreandoPedido.CODIGO).isValid();
	}
