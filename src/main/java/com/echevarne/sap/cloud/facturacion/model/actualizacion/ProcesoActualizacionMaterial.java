...
@Entity
@Table(name = "T_ProcesoActualizacionMaterial")
@AllArgsConstructor 
@NoArgsConstructor
@Getter
@Setter
...
public class ProcesoActualizacionMaterial extends BasicEntity {
	...
	@Basic
	@ValueList(CollectionPath = ValueListEntitiesEnum.MaterialesVenta, Label = "Oficina de ventas", Parameters = {
	...
	public ProcesoActualizacionMaterial(String material) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProcesoActualizacionMaterial other = (ProcesoActualizacionMaterial) obj;
