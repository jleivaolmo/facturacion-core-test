...
@Table(name = "VT_ESTADOFACTURACION")
@SapEntitySet(creatable = false, updatable = false, searchable = false, deletable = false)
@JPAExit(allowAll = false, fieldId = "nombre")
public class EstadoFacturacionText implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6210084264344463118L;
