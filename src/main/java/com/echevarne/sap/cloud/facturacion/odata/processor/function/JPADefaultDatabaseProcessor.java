...
public class JPADefaultDatabaseProcessor extends JPAAbstractDatabaseProcessor {

  @Override
  public <T> List<T> executeFunctionQuery(GetEntitySetUriInfo uriInfo, final JPASQLStatement statement,
      final JPASQLContextPlaceholder contextPlaceholder, final JPADataBaseFunction jpaFunction,
      JPAEdmMappingImpl entityType, final EntityManager em) throws ODataException {
    return executeQuery(uriInfo, statement, contextPlaceholder, jpaFunction, entityType, em);
  }
