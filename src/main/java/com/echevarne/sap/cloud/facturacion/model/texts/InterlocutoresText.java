...
@Table(name = "VT_INTERLOCUTORES")
@SapEntitySet(creatable = false, updatable = false, searchable = true)
@JPAExit(allowAll = true, fieldId = "codigoCliente", fieldDescription = "nombreCliente")
public class InterlocutoresText implements Serializable {
