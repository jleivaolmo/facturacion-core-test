...
@Entity
@Table(name = "T_ReglaLiquidacionProfesionalesOficinaVentas")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionProfesionalesOficinaVentas extends BasicEntity {
	...
	public ReglaLiquidacionProfesionalesOficinaVentas(String oficinaVentas) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionProfesionalesOficinaVentas other = (ReglaLiquidacionProfesionalesOficinaVentas) obj;
