...
@Table(name = "V_ACTIVIDAD_FACTURADA_AGRUPADA_COBROS")
@SapEntitySet(creatable = false, updatable = false, searchable = false, deletable = false)
public class ActividadFacturadaAgrupada implements Serializable {

	private static final long serialVersionUID = 1396045742135264160L;
