...
/**
 * Class for the Entity {@link FacturableFechaPeticion}.
 */
@Getter
@Setter
@Entity
@Table(name = ConstEntities.ENTIDAD_FACTURABLEFECHAPETICION, indexes = {
		@Index(name = "IDX_FacturableFechaPeticion", columnList = "organizacionVentas,cliente,oficinaVentas,tipoPeticion,empresa,compania,remitente,validez_desde", unique = true), })
@SapEntitySet(searchable = false)
public class FacturableFechaPeticion extends BasicEntity {
	...
	@Priorizable
	@Column(length = 10)
	@ValueList(CollectionPath = ValueListEntitiesEnum.Empresas, Label = "Empresa", Parameters = { @ValueListParameter(ValueListParameterInOut = {
	...
	@Priorizable
	@Column(length = 10)
	@ValueList(CollectionPath = ValueListEntitiesEnum.Remitentes, Label = "Remitente", Parameters = { @ValueListParameter(ValueListParameterInOut = {
	...
	public boolean onEquals(Object obj) {
		...
		if (obj == null || getClass() != obj.getClass())
			return false;
		FacturableFechaPeticion other = (FacturableFechaPeticion) obj;
		return Objects.equals(this.organizacionVentas, other.organizacionVentas) && Objects.equals(this.cliente, other.cliente)
				&& Objects.equals(this.oficinaVentas, other.oficinaVentas) && Objects.equals(this.tipoPeticion, other.tipoPeticion) && Objects.equals(this.empresa, other.empresa)
				&& Objects.equals(this.compania, other.compania) && Objects.equals(this.remitente, other.remitente);
	}
