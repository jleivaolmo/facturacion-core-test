...
@Component(SinEstado.CODIGO)
public class SinEstado extends FacturacionEstado {

	public static final String CODIGO = "SE";

	@Override
	public boolean doTransicion(SolicitudMuestreo peticionMuestreo, MasDataEstado estadoOrigen, boolean manual) {
		return true;
	}
