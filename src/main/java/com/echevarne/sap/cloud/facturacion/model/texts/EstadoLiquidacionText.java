...
@Table(name = "VT_ESTADOLIQUIDACION")
...
public class EstadoLiquidacionText implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5233530895470153692L;
