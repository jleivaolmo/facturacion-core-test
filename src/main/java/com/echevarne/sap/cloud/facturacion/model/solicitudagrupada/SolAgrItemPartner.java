...
/**
 * Class for the Entity {@link SolAgrItemPartner}.
 *
 * <p>The persistent class. . .T_SolAgrItemPartner</p>
 ...
 */
@Entity
@Table(name = "T_SolAgrItemPartner")
@SapEntitySet(creatable = false, updatable = false, searchable = true, deletable = false)
public class SolAgrItemPartner extends BasicEntity implements Serializable{

	/**
	 *
	 */
	private static final long serialVersionUID = 5792307073687730469L;
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SolAgrItemPartner other = (SolAgrItemPartner) obj;
