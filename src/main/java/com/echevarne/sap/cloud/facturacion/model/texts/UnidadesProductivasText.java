...
@Table(name = "VT_UNIDADES_PRODUCTIVAS")
@SapEntitySet(creatable = false, updatable = false, searchable = true)
@JPAExit(allowAll = true, fieldId = "codigo", fieldDescription = "nombre")
public class UnidadesProductivasText implements Serializable {

	private static final long serialVersionUID = -7703309027664289605L;
