...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesConceptoFact")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesConceptoFact extends BasicEntity {
	...
	public ReglaLiquidacionRemitentesConceptoFact(String codigoConcepto) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesConceptoFact other = (ReglaLiquidacionRemitentesConceptoFact) obj;
