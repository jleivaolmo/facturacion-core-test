...
@Entity
@Table(name = "T_ProcesoActualizacionConceptosFact")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ProcesoActualizacionConceptosFact extends BasicEntity {
	...
	@ValueList(CollectionPath = ValueListEntitiesEnum.ConceptosFacturacion, Label = "Concepto facturacion", Parameters = {
			@ValueListParameter(ValueListParameterInOut = {
					@ValueListParameterInOut(ValueListProperty = "codigoMaterial", LocalDataProperty = "conceptoFact") }, ValueListParameterDisplayOnly = {
	...
	public ProcesoActualizacionConceptosFact(String conceptoFact) {
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@LazyToOne(LazyToOneOption.NO_PROXY)
	@JoinColumn(name = "conceptoFact", insertable = false, updatable = false, nullable = true, foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProcesoActualizacionConceptosFact other = (ProcesoActualizacionConceptosFact) obj;
		return Objects.equals(conceptoFact, other.conceptoFact);
	}
}
