...
@Component(Borrada.CODIGO)
public class Borrada extends FacturacionEstado {

	public static final String CODIGO = "DEL";

	@Override
	public boolean doTransicion(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		// La peticion no contiene items
		return !validacionesSolInd.hasPeticionItems(solicitudIndividual).isValid();
	}
