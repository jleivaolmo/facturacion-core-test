...
@Table(name = "V_LIQ_PROFESIONALES")
...
@OverrideEntity(entityClass = LiquidacionProfesionales.class)
public class LiquidacionProfesionales implements Serializable {
	...
	public LiquidacionProfesionales(String sociedad, String organizacionCompras, String grupoCompras, String proveedor,
	...
	@WhereField(fieldName = "codigoProfesional")
