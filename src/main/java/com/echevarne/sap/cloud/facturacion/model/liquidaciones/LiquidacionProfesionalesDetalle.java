...
@Table(name = "V_LIQ_PROFESIONALES_DETALLE")
@IdClass(LiquidacionDetalleKey.class)
@SapEntitySet(creatable = false, updatable = false, searchable = false, deletable = false)
public class LiquidacionProfesionalesDetalle implements Serializable {
	...
	@Basic
	@Id
	@ValueList(CollectionPath = ValueListEntitiesEnum.S4Proveedores, Label = "Proveedor", Parameters = { @ValueListParameter(ValueListParameterInOut = {
	...
	@Basic
	@ValueList(CollectionPath = ValueListEntitiesEnum.S4Impuestos, Label = "Indicador IVA", Parameters = { @ValueListParameter(ValueListParameterInOut = {
	...
	@Basic
	@ValueList(CollectionPath = ValueListEntitiesEnum.Estados, Label = "Estado de la petición", Parameters = { @ValueListParameter(ValueListParameterInOut = {
