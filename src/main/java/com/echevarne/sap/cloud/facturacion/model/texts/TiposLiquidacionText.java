...
@Table(name = "VT_TIPOSLIQUIDACION")
...
public class TiposLiquidacionText implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1747245207810157913L;
