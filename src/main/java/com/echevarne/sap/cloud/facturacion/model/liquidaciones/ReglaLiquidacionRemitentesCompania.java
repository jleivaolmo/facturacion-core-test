...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesCompania")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesCompania extends BasicEntity {
	...
	public ReglaLiquidacionRemitentesCompania(String compania) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesCompania other = (ReglaLiquidacionRemitentesCompania) obj;
