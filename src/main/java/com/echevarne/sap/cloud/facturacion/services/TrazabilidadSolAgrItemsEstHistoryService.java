...
/**
 * Class for services {@link TrazabilidadSolAgrItemsEstHistory}.
 * <p>Services for the bussiness logic of the Model: TrazabilidadSolicitudEstHistory</p>
 *
 * @author David Bolet
 * @since 28/04/2021
 */
public interface TrazabilidadSolAgrItemsEstHistoryService extends CrudService<TrazabilidadSolAgrItemsEstHistory, Long> {
