...
@Component(PedidoCreado.CODIGO)
public class PedidoCreado extends FacturacionEstado {

	public static final String CODIGO = "PC";
	...
	public boolean doTransicion(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		return validacionesSolInd.hasItemsStatus(solicitudIndividual,PedidoCreado.CODIGO).isValid();
	}
	
	@Override
	public boolean doTransicionV2(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		return validacionesSolInd.hasItemsStatusV2(solicitudIndividual,PedidoCreado.CODIGO).isValid();
	}
