...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesUndProductiva")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesUndProductiva extends BasicEntity {
	...
	public ReglaLiquidacionRemitentesUndProductiva(String unidadProductiva) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesUndProductiva other = (ReglaLiquidacionRemitentesUndProductiva) obj;
