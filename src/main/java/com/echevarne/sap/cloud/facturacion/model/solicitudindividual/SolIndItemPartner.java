...
/**
 * Class for the Entity {@link SolIndItemPartner}.
 *
 * <p>The persistent class. . .T_SolIndItemPartner</p>
 ...
 */
@Entity
@Table(name = "T_SolIndItemPartner")
@SapEntitySet(creatable = false, updatable = false, searchable = true, deletable = false)
public class SolIndItemPartner extends BasicEntity implements Serializable {

	/**
	 *
	 */
	private static final long serialVersionUID = -807390069888692129L;
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SolIndItemPartner other = (SolIndItemPartner) obj;
