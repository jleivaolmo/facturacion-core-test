...
@Table(name = "VT_OFICINA_VENTAS")
@SapEntitySet(creatable = false, updatable = false, searchable = true)
@JPAExit(allowAll = true, allowEmpty = true, fieldId = "codigoOficina", fieldDescription = "nombreOficina")
public class OficinaVentaText implements Serializable {
