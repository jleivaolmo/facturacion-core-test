...
@Entity 
@Table(name = "V_ACTIVIDAD_FACTURADA_PENDIENTE")
@ToString(callSuper = false, includeFieldNames = false)
@Getter
@Setter
@Builder
public class ActFacturadaPendiente implements Serializable {

	private static final long serialVersionUID = 6705959590617263030L;
