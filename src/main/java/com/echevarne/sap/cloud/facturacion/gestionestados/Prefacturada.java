...
@Component(Prefacturada.CODIGO)
public class Prefacturada extends FacturacionEstado {

	public static final String CODIGO = "PF";
	...
	public boolean doTransicion(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		return validacionesSolInd.hasItemsStatus(solicitudIndividual,Prefacturada.CODIGO).isValid();
	}
	
	@Override
	public boolean doTransicionV2(SolicitudIndividual solicitudIndividual, MasDataEstado estadoOrigen, boolean manual) {
		return validacionesSolInd.hasItemsStatusV2(solicitudIndividual,Prefacturada.CODIGO).isValid();
	}
