...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "T_ReglaLiquidacionProfesionales", indexes = {
		@Index(name = "IDX_ReglaLiquidacionProfesionales", columnList = "descripcion, prioridad, validoDesde, validoHasta, "
...
public class ReglaLiquidacionProfesionales extends BasicEntity {
	...
	private Set<ReglaLiquidacionProfesionalesCliente> clientes = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesOficinaVentas> oficinasVentas = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesCodProfesional> profesionales = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesUndProductiva> undsProductivas = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesConceptoFact> conceptosFact = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesTipoPet> tiposPet = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesCompania> companias = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesPrueba> pruebas = new HashSet<>();

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "reglaLiquidacion", orphanRemoval = true)
	@JsonManagedReference
	private Set<ReglaLiquidacionProfesionalesDelProductiva> delsProductiva = new HashSet<>();
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionProfesionales other = (ReglaLiquidacionProfesionales) obj;
