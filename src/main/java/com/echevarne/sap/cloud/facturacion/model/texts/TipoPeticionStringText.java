...
@Table(name = "VT_TIPO_PETICION_STR")
@SapEntitySet(creatable = false, updatable = false, searchable = true)
@JPAExit(allowAll = true, fieldId = "tipoPeticion", fieldDescription = "nombreTipoPeticion")
public class TipoPeticionStringText implements Serializable {
