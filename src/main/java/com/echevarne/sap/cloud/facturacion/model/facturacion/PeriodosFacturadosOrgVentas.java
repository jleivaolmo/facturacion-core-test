...
@Entity
@Table(name = ConstEntities.ENTIDAD_FACTLOGPERIODOSORGVENTAS)
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
@SapEntitySet(creatable = false, updatable = false, searchable = true, deletable = false)
public class PeriodosFacturadosOrgVentas extends BasicEntity {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PeriodosFacturadosOrgVentas other = (PeriodosFacturadosOrgVentas) obj;
