...
@Table(name = "VT_TIPO_LIQUIDACION")
@SapEntitySet(creatable = false, updatable = false, searchable = true)
@JPAExit(allowAll = true, fieldId = "tipoLiquidacion", fieldDescription = "nombreLiquidacion")
public class TipoLiquidacionText implements Serializable {
