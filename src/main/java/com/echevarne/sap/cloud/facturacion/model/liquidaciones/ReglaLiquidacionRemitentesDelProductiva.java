...
@Entity
@Table(name = "T_ReglaLiquidacionRemitentesDelProductiva")
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
...
public class ReglaLiquidacionRemitentesDelProductiva extends BasicEntity {
	...
	public ReglaLiquidacionRemitentesDelProductiva(String delegacionProductiva) {
	...
	public boolean onEquals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReglaLiquidacionRemitentesDelProductiva other = (ReglaLiquidacionRemitentesDelProductiva) obj;
